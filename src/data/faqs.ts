...
export const generalFaqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "Absolutely. We collaborate with clients across regions and time zones. Everything from kickoff to handover runs smoothly online through calls, shared boards, and regular previews you can click through.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. We don't disappear at launch. We offer ongoing maintenance, performance monitoring, and growth support so your platform keeps improving long after it goes live.",
  },
  {
...
export const servicesFaqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "We do. We can set up hosting, domains, SSL, and continuous deployment, or work alongside your existing providers. Either way, you get a smooth, secure launch with zero guesswork.",
  },
  {
    question: "Can I manage content myself after handover?",
    answer:
      "Of course. We build intuitive admin tools and dashboards so your team can update content, products, and data without needing a developer on call.",
  },
  {
...
export const contactFaqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "Every project is scoped to your needs, so pricing varies. After understanding your requirements we share a transparent, itemized quote so you know exactly what you're paying for before anything begins.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A few lines about your business, what you're trying to achieve, and any timeline or budget range you have in mind is plenty. The more context you share, the more precise our first response will be.",
  },
];
