...
-- =============================================================================
-- The canonical starting point for the database, captured as a Supabase CLI
-- migration. Everything here is idempotent. Future changes must be added as new
-- timestamped migrations in this folder — never edit this file.
--
-- Tables
...
--
-- Security model
--   • Anonymous visitors may INSERT contact messages + unpublished testimonials
--     and READ published testimonials / blog posts. Nothing else is exposed.
...
-- Server-side validation + per-email throttling (defence in depth).
...
-- Visitors may submit a testimonial, but only as an UNPUBLISHED draft.
